...
import { ArrowRight, ArrowLeft, Sparkles, Zap, Globe, Users } from 'lucide-react';
      ...
      <nav className="bg-white shadow-sm py-4">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <div className="flex items-center">
            <span className="text-xl font-bold text-blue-600">NTQ Utilities</span>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 text-gray-800 tracking-tight leading-tight">
                AI-Powered Utilities <span className="text-blue-600">for Everyone</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-6 rounded-lg flex items-center gap-2 text-base">
                  Explore Utilities
                  <ArrowRight className="h-4 w-4" />
                </Button>
                <Button variant="outline" className="border-blue-200 text-blue-600 hover:bg-blue-50 px-6 py-6 rounded-lg flex items-center gap-2 text-base">
                  Learn More
                </Button>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {featuredUtilities.map((utility, index) => (
              ...
              >
                <div className="bg-white p-3 rounded-full w-14 h-14 flex items-center justify-center mb-4 shadow-sm">
                  {utility.icon}
                </div>
                <h3 className="text-xl font-semibold text-gray-800 mb-2">{utility.title}</h3>
